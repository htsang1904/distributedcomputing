(self.webpackChunkapi=self.webpackChunkapi||[]).push([[2544],{23341:function(Y,Z,r){"use strict";r.r(Z),r.d(Z,{CreatePage:function(){return Ce},default:function(){return Me}});var e=r(67294),v=r(66115),o=r(91134),T=r(185),I=r(53979),b=r(11047),P=r(29728),R=r(49066),x=r(41580),B=r(75515),j=r(11276),F=r(74571),y=r(16364),u=r(64256),N=r(67109),Q=r(41054),z=r(27361),fe=r.n(z),A=r(41609),X=r.n(A),me=r(86896),f=r(16550),q=r(88972),w=r(18280),ee=r(48474),ie=r(87751),le=r(87561),ye=le.Ry().shape({name:le.Z_().required(o.I0.required),description:le.Z_().required(o.I0.required)});const de=q.ZP.div`
...
`,F=({children:y,disabled:u=!1,error:N,expanded:Q=!1,hasErrorMessage:z=!0,id:fe,onToggle:A,toggle:X,size:me="M",variant:f="primary",shadow:q})=>{const w=(0,I.M)(fe),ee=v.useMemo(()=>({expanded:Q,onToggle:A,toggle:X,id:w,size:me,variant:f,disabled:u}),[u,Q,w,A,me,X,f]);return(0,e.jsxs)(T.S.Provider,{value:ee,children:[(0,e.jsx)(j,{"data-strapi-expanded":Q,disabled:u,"aria-disabled":u,expanded:Q,hasRadius:!0,variant:f,error:N,shadow:q,children:y}),N&&z&&(0,e.jsx)(R.x,{paddingTop:1,children:(0,e.jsx)(b.Z,{variant:"pi",textColor:"danger600",children:N})})]})}},63081:function(Y,Z,r){"use strict";r.d(Z,{v:function(){return T}});var e=r(85893),v=r(13819),o=r(41580);const T=({children:I,...b})=>{const{expanded:P,id:R}=(0,v.A)();if(!P)return null;const x=`accordion-content-${R}`,B=`accordion-label-${R}`,j=`accordion-desc-${R}`;return(0,e.jsx)(o.x,{role:"region",id:x,"aria-labelledby":B,"aria-describedby":j,...b,children:I})}},13819:function(Y,Z,r){"use strict";r.d(Z,{A:function(){return o},S:function(){return v}});var e=r(67294);const v=(0,e.createContext)({disabled:!1,expanded:!1,id:"",size:"M",variant:"primary"}),o=()=>(0,e.useContext)(v)},74756:function(Y,Z,r){"use strict";r.d(Z,{B:function(){return y}});var e=r(85893),v=r(12645),o=r(88972),T=r(48734),I=r(13819);const b=({expanded:u,disabled:N,variant:Q})=>{let z="neutral100";return u?z="primary100":N?z="neutral150":Q==="primary"&&(z="neutral0"),z};var P=r(39785),R=r(52624),x=r(11047),B=r(75515);const j=(0,o.ZP)(P.A)`
  text-align: left;
...
`,x=({children:j})=>(0,e.jsxs)(R,{inline:!0,as:"li",children:[(0,e.jsx)(P.Z,{variant:"pi",textColor:"neutral600",children:j}),(0,e.jsx)(b.x,{"aria-hidden":!0,paddingLeft:3,paddingRight:3,children:(0,e.jsx)(v.Z,{})})]});x.displayName="Crumb";const B=({children:j,label:F,...y})=>(0,e.jsxs)(I.k,{...y,children:[(0,e.jsx)(T.T,{children:F}),(0,e.jsx)("ol",{"aria-hidden":!0,children:j})]});B.displayName="Breadcrumbs"},38953:function(Y,Z,r){"use strict";r.d(Z,{Q:function(){return T}});var e=r(85893),v=r(88972),o=r(67730);const T=({options:b,...P})=>(0,e.jsx)(o.NU,{...P,children:b.map(R=>"children"in R?(0,e.jsx)(o.Ab,{label:R.label,values:R.children.map(x=>x.value.toString()),children:R.children.map(x=>(0,e.jsx)(I,{value:x.value,children:x.label},x.value))},R.label):(0,e.jsx)(o.ML,{value:R.value,children:R.label},R.value))}),I=(0,v.ZP)(o.ML)`
