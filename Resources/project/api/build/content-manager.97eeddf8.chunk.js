...
`;var vn=d(21817);const Pe=(0,N.ZP)(ye.h)`
  padding: ${({theme:t})=>t.spaces[2]};
...
`;var Xa=d(19954);const Mn=({onToggleExpand:t})=>{const{formatMessage:r}=(0,H.Z)();return e.createElement(S.x,{padding:2,background:"neutral100",hasRadius:!0},e.createElement(F.k,{justifyContent:"flex-end",alignItems:"flex-end"},e.createElement(Aa,{id:"expand",onClick:t},e.createElement(Q.Z,null,r({id:"components.WysiwygBottomControls.fullscreen",defaultMessage:"Expand"})),e.createElement(Xa.Z,null))))};Mn.defaultProps={onToggleExpand(){}},Mn.propTypes={onToggleExpand:n().func};var Ja=Mn;const Tn=({id:t,error:r,name:o,hint:s})=>s.length===0||r?null:e.createElement(Q.Z,{as:"p",variant:"pi",id:`${t||o}-hint`,textColor:"neutral600"},s);Tn.defaultProps={id:void 0,error:void 0,hint:""},Tn.propTypes={hint:n().oneOfType([n().string,n().array]),error:n().string,id:n().string,name:n().string.isRequired};var _a=Tn;const no=(t,r)=>{let o;switch(t){case"Strikethrough":o=`~~${r}~~`;break;case"Bold":o=`**${r}**`;break;case"Italic":o=`_${r}_`;break;case"Underline":o=`<u>${r}</u>`;break;case"Code":o=`\`\`\`
${r}
...
`,Ln=({children:t,overflow:r,...o})=>e.createElement(wi,{overflowDirection:r,...o},t);Ln.defaultProps={overflow:""},Ln.propTypes={children:n().node.isRequired,overflow:n().oneOf(["top-bottom","bottom","top",""])};var Fi=d(5079);const Li=N.ZP.div`
  flex-shrink: 0;
  width: ${(0,h.Q1)(6)};
  height: ${(0,h.Q1)(6)};
  margin-right: ${({theme:t})=>t.spaces[2]};
